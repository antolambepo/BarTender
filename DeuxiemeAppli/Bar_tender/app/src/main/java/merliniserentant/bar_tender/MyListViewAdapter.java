...
public class MyListViewAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = mInflater.inflate(R.layout.collector_row_item, parent, false);
        }

        // Récupération des 4 éléments de notre vue dans le but d'y placer les données.
        TextView nameTextView = (TextView) convertView.findViewById(R.id.nomboisson);
        TextView stockTextView = (TextView) convertView.findViewById(R.id.stock);
        TextView stockMaxTextView = (TextView) convertView.findViewById(R.id.stockmax);
        TextView seuilTextView = (TextView) convertView.findViewById(R.id.seuil);
